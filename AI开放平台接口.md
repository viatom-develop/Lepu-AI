...
```jsonc
   {
        ...
        "ecg": {
            "measure_time": "", //开始测量时间，支持UTC格式(即0时区时间,如2022-10-01T10:30:00Z,注意与本地当前时间的正确换算)和本地当前时间格式(如2022-08-01 10:25:00),
...
2. 设备列表
   ...
   | Lepu | ER2   | 单导联心电记录仪 |
   | Lepu | ER2-S | 单导联心电记录仪 |
   | Lepu | 心电体脂秤S1    | 心电体脂秤S1|
   | Lepu | BP2   | 心电血压计       |
   | Lepu | BP2-Pro   | 心电血压计wifi版       |
   | Lepu | 手表W1 | 乐普手表W1       |
   |      | 通用设备类型 | 如果您使用其他品牌的设备，请使用“通用设备类型”，或者与我们联系 |
...
2. 设备列表
   ...
   | band | model | 备注                |
   | ---- | ----- | ----------------   |  
   | Lepu | PC-700| PC700一体机         |
   | Lepu | PCECG-500| PCECG-500一体机         |
